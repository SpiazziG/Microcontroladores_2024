...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDialogENDCLASS_t qt_meta_stringdata_CLASSDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 17),  // "requestResetTimer"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 24),  // "onSignalSelectionChanged"
...
Q_CONSTINIT const QMetaObject Dialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDialogENDCLASS_t,
        ...
        // method 'requestResetTimer'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onSignalSelectionChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->requestResetTimer(); break;
        case 1: _t->onSignalSelectionChanged((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Dialog::requestResetTimer; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
