...
"margin-top: 2px;"));
        ...
        sizePolicy.setHeightForWidth(spinBoxStartX->sizePolicy().hasHeightForWidth());
        spinBoxStartX->setSizePolicy(sizePolicy);
...
"background-color: transparent;"));
        ...
        sizePolicy.setHeightForWidth(spinBoxStartY->sizePolicy().hasHeightForWidth());
        spinBoxStartY->setSizePolicy(sizePolicy);
        spinBoxStartY->setStyleSheet(QString::fromUtf8("font: 11pt \"Century Gothic\";\n"
"font-weight: bold;\n"
"background-color: rgb(57, 63, 68);\n"
"color: rgb(227, 227, 229);"));
        spinBoxStartY->setAlignment(Qt::AlignCenter);
        spinBoxStartY->setMaximum(7);
...
"color: rgb(227, 227, 229);"));
        ...
        sizePolicy.setHeightForWidth(comboBoxStartDir->sizePolicy().hasHeightForWidth());
        comboBoxStartDir->setSizePolicy(sizePolicy);
...
"margin-top: 2px;"));
        ...
        gridLayout_19->addWidget(tabWidget, 0, 0, 1, 2);
